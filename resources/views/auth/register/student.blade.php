                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('createStudent') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="phone" minlength="13" maxlength="13" type="tel" class="form-control @error('mobile_no') is-invalid @enderror" name="mobile_no" placeholder="+353" value="+353" required autocomplete="mobile-no">
