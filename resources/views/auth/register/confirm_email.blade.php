                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="min-width:100%; ">
                                <tr>
                                    <td width="100%" style="min-width:100%;background-color:#F8F7F0;color:#686868;padding:30px;">
                                        <h2 style="font-family:Arial;font-size:36px;line-height:44px;padding-top:10px;padding-bottom:10px; text-align: center">Account Activation</h2>

                                        <br> <p style="text-align:center;">Verify your account by clicking on this  <i><a style="color: #FB8A2E;; text-decoration: none" href="{{url}}">link.</a></i>
                                        </p>
                                        <br>
                                        ...
                                        <form action="{{url}}"><input style="background-color: #FB8A2E;;
                                            ...
                                            cursor: pointer;" type="submit" value="Activate"> </form>                                   </td>
                                </tr>
                            </table>
                            <table width="100%" cellpadding="0" cellspacing="0" style="min-width:100%; background-color: black; ">
                                <tr>
                                    <td width="100%" style="min-width:100%;background-color:#313E46;color:whitesmoke;;padding:30px;">
                                        <p style="font-size:16px;line-height:20px;font-family:Georgia,Arial,sans-serif;text-align:center;">2018 @ COPYRIGHT - <a style="color:#FB8A2E; text-decoration: none" target="_blank" href="{{ $home }}">Queen Ede</a> </p>
                                    </td>
                                </tr>
                            </table>
                        </td>
