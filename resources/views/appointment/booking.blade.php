...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header text-center" style="font-weight: bolder">{{ __('Appointment Booking') }}</div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('appointment.create') }}">
                            ...
                            <div class="form-group row">
                                <label for="student_no" class="col-md-4 col-form-label text-md-right">{{ __('Appointment Booking Ref No.') }}</label>
